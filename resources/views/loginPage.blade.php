...
@section('content')
    ...
    <nav class="w-full h-[100px] flex justify-between items-center bg-white/90 backdrop-blur-sm px-12 border-b border-[#e4e4e4] sticky top-0 z-50">
        ...
        <div class="flex items-center gap-10">
            <div class="h-[50px] flex justify-center items-center bg-[#e8a838] px-10 py-2 rounded-[56px] shadow-xl shadow-orange-200/40 cursor-default">
                <span class="font-bold text-[16px] text-white">Login</span>
            </div>
            <a href="{{ route('register') }}" class="font-semibold text-gray-800 hover:text-[#e8a838] transition-colors">Register</a>
        </div>
    </nav>
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-12 relative z-10">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-[36px] font-extrabold text-black tracking-tight mb-2">Selamat Datang Kembali</h1>
            <p class="text-gray-400 font-medium">Masuk untuk memantau kontribusi nyatamu dalam ekosistem kolektif kami.</p>
        </div>
        ...
        <div class="w-full max-w-[480px] bg-white border border-[#e4e4e4] p-10 rounded-[32px] shadow-2xl shadow-gray-100">
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div class="text-left">
                    ...
                    <div class="mt-2 text-right">
                        <a href="#" class="text-[13px] font-bold text-[#013599] hover:underline">Lupa password?</a>
                    </div>
                </div>
                ...
                <button type="submit" class="w-full bg-gradient-to-b from-[#e8a838] to-[#ffa200] text-white font-bold py-5 rounded-2xl shadow-xl shadow-orange-200 flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all group">
                    <span class="text-[17px]">Masuk Sekarang</span>
                    <div class="bg-white w-9 h-9 rounded-full flex items-center justify-center shadow-sm group-hover:rotate-12 transition-transform">
                        <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none">
                            <path d="M7 17L17 7M17 7H7M17 7V17" stroke="url(#blueGradLogin)" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <defs>
                                <linearGradient id="blueGradLogin" x1="7" y1="7" x2="17" y2="17" gradientUnits="userSpaceOnUse">
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-400 font-medium">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-[#013599] font-bold hover:underline">Daftar di sini</a>
                </p>
            </div>
        </div>
    </main>
